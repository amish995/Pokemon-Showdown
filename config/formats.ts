...
export const Formats: FormatList = [
	...
	{
		name: "[Gen 8] (National Dex) PSS Season 9",
		mod: 'gen8',
		ruleset: ['Standard NatDex', 'OHKO Clause', 'Evasion Moves Clause', 'Species Clause', 'Dynamax Clause', 'Sleep Clause Mod', 'Z-Move Clause', '+Unreleased', 'Mega Rayquaza Clause'],
		// ruleset: ['Standard NatDex', 'OHKO Clause', 'Evasion Moves Clause', 'Species Clause', 'Dynamax Clause', 'Sleep Clause Mod'],
		banlist: ["Karate Chop", "Double Slap", "Comet Punch", "Razor Wind", "Jump Kick", "Rolling Kick", "Twineedle", "Sonic Boom", "Dragon Rage", "Meditate", "Rage", "Barrier", "Bide", "Mirror Move", "Egg Bomb", "Bone Club", "Clamp", "Spike Cannon", "Constrict", "Kinesis", "Barrage", "Bubble", "Dizzy Punch", "Flash", "Psywave", "Sharpen", "Spider Web", "Nightmare", "Feint Attack", "Foresight", "Return", "Frustration", "Magnitude", "Pursuit", "Smelling Salts", "Assist", "Refresh", "Snatch", "Secret Power", "Camouflage", "Mud Sport", "Ice Ball", "Needle Arm", "Odor Sleuth", "Silver Wind", "Grass Whistle", "Signal Beam", "Sky Uppercut", "Water Sport", "Miracle Eye", "Wake-Up Slap", "Natural Gift", "Embargo", "Trump Card", "Heal Block", "Wring Out", "Lucky Chant", "Me First", "Punishment", "Mud Bomb", "Mirror Shot", "Rock Climb", "Magnet Bomb", "Captivate", "Heal Order", "Ominous Wind", "Telekinesis", "Flame Burst", "Synchronoise", "Chip Away", "Sky Drop", "Bestow", "Heart Stamp", "Steamroller", "Rototiller", "Ion Deluge", "Tail Glow", "Heart Swap", "Spotlight", "Psycho Boost", "Blazikenite + Swords Dance", "Blazikenite + Bulk Up", "Blazikenite + Power-Up Punch", "Blazikenite + Hone Claws", "Blazikenite + Agility", "Blazikenite + Curse", "Blazikenite + Work Up", "Blazikenite + Flame Charge", "Blastoisinite + Shell Smash", "Kangaskhanite + Seismic Toss", "Zygarde-Base + Power Construct", "Glalitite + Moody", "Blaziken + Swords Dance", "Giratina-Origin + Rest", "Kyurem-Black + Dragon Dance", "Mewtwo + Nasty Plot", "Reshiram + Dragon Dance", "Rayquaza + Dragon Dance", "Zekrom + Dragon Dance"],
		unbanlist: ['Deoxys-Speed', 'Deoxys-Defense', 'Landorus-Base', 'Kyurem-Black', 'Melmetal',],
		onValidateSet(set){
			if (set.species == "Dialga" && !set.item.includes("Adamant Orb")){
				return ['Dialga must hold Adamant Orb']
			}
			if (set.species == "Genesect" && !set.item.includes("Drive")){
				return ['Genesect must hold a drive']
			}
	...
	{
		name: "[Gen 8] (National Dex) NCL Season 9",
		mod: 'gen8',
		...
		banlist: ["Blaziken + Speed Boost", "Karate Chop", "Double Slap", "Comet Punch", "Razor Wind", "Jump Kick", "Rolling Kick", "Twineedle", "Sonic Boom", "Dragon Rage", "Meditate", "Rage", "Barrier", "Bide", "Mirror Move", "Egg Bomb", "Bone Club", "Clamp", "Spike Cannon", "Constrict", "Kinesis", "Barrage", "Bubble", "Dizzy Punch", "Flash", "Psywave", "Sharpen", "Spider Web", "Nightmare", "Feint Attack", "Foresight", "Return", "Frustration", "Magnitude", "Pursuit", "Hidden Power", "Smelling Salts", "Assist", "Refresh", "Snatch", "Secret Power", "Camouflage", "Mud Sport", "Ice Ball", "Needle Arm", "Odor Sleuth", "Silver Wind", "Grass Whistle", "Signal Beam", "Sky Uppercut", "Water Sport", "Miracle Eye", "Wake-Up Slap", "Natural Gift", "Embargo", "Trump Card", "Heal Block", "Wring Out", "Lucky Chant", "Me First", "Punishment", "Mud Bomb", "Mirror Shot", "Rock Climb", "Magnet Bomb", "Captivate", "Heal Order", "Ominous Wind", "Telekinesis", "Flame Burst", "Synchronoise", "Chip Away", "Sky Drop", "Bestow", "Heart Stamp", "Steamroller", "Rototiller", "Ion Deluge","Tail Glow", "Heart Swap", "Spotlight", "Psycho Boost","Alakazite + Nasty Plot", "Blastoisinite + Shell Smash", "Kangaskhanite + Seismic Toss", 'Kyurem-Black + Dragon Dance', "Genesect + Shift Gear", "Zamazenta-Crowned + Howl", "Zamazenta-Crowned + Work Up", "Shaymin-Sky + Seed Flare"],
		unbanlist: ['Floette-Eternal', 'Blaziken', 'Deoxys-Speed', 'Deoxys-Defense', 'Landorus-Base', 'Kyurem-Black', 'Melmetal', "Fire Gem", "Water Gem", "Electric Gem", "Grass Gem", "Ice Gem", "Fighting Gem", "Poison Gem", "Ground Gem", "Flying Gem", "Psychic Gem", "Bug Gem", "Rock Gem", "Ghost Gem", "Dragon Gem", "Dark Gem", "Steel Gem", "Normal Gem", "Fairy Gem", ],	
		onValidateSet(set) {
		if (set.species == "Genesect" && !set.item.includes("Drive")){
			return ['Genesect must hold a drive']
		}
	...
	// {
	// 	name: "[Gen 8] Sneasel Cup",
	// 	mod: 'gen8',
	// 	forcedLevel: 25,
	// 	ruleset: ['Standard NatDex', 'OHKO Clause', 'Evasion Moves Clause', 'Species Clause', 'Dynamax Clause', 'Sleep Clause Mod', 'Z-Move Clause', 'Item Clause'],
	// 	banlist: ["Karate Chop", "Double Slap", "Comet Punch", "Razor Wind", "Jump Kick", "Rolling Kick", "Twineedle", "Sonic Boom", "Dragon Rage", "Meditate", "Rage", "Barrier", "Bide", "Mirror Move", "Egg Bomb", "Bone Club", "Clamp", "Spike Cannon", "Constrict", "Kinesis", "Barrage", "Bubble", "Dizzy Punch", "Flash", "Psywave", "Sharpen", "Spider Web", "Nightmare", "Feint Attack", "Foresight", "Return", "Frustration", "Magnitude", "Pursuit", "Hidden Power", "Smelling Salts", "Assist", "Refresh", "Snatch", "Secret Power", "Camouflage", "Mud Sport", "Ice Ball", "Needle Arm", "Odor Sleuth", "Silver Wind", "Grass Whistle", "Signal Beam", "Sky Uppercut", "Water Sport", "Miracle Eye", "Wake-Up Slap", "Natural Gift", "Embargo", "Trump Card", "Heal Block", "Wring Out", "Lucky Chant", "Me First", "Punishment", "Mud Bomb", "Mirror Shot", "Rock Climb", "Magnet Bomb", "Captivate", "Heal Order", "Ominous Wind", "Telekinesis", "Flame Burst", "Synchronoise", "Chip Away", "Sky Drop", "Bestow", "Heart Stamp", "Steamroller", "Rototiller", "Ion Deluge","Tail Glow", "Heart Swap", "Spotlight", "Psycho Boost"],
	// },
	{
		name: "[Gen 8] (National Dex) WWC Season 6",
		mod: 'gen8',
		ruleset: ['Standard NatDex', 'OHKO Clause', 'Evasion Moves Clause', 'Species Clause', 'Dynamax Clause', 'Sleep Clause Mod', 'Z-Move Clause', '+Unreleased'],
		banlist: ["Blaziken + Speed Boost", "Karate Chop", "Double Slap", "Comet Punch", "Razor Wind", "Jump Kick", "Rolling Kick", "Twineedle", "Sonic Boom", "Dragon Rage", "Meditate", "Rage", "Barrier", "Bide", "Mirror Move", "Egg Bomb", "Bone Club", "Clamp", "Spike Cannon", "Constrict", "Kinesis", "Barrage", "Bubble", "Dizzy Punch", "Flash", "Psywave", "Sharpen", "Spider Web", "Nightmare", "Feint Attack", "Foresight", "Return", "Frustration", "Magnitude", "Pursuit", "Hidden Power", "Smelling Salts", "Assist", "Refresh", "Snatch", "Secret Power", "Camouflage", "Mud Sport", "Ice Ball", "Needle Arm", "Odor Sleuth", "Silver Wind", "Grass Whistle", "Signal Beam", "Sky Uppercut", "Water Sport", "Miracle Eye", "Wake-Up Slap", "Natural Gift", "Embargo", "Trump Card", "Heal Block", "Wring Out", "Lucky Chant", "Me First", "Punishment", "Mud Bomb", "Mirror Shot", "Rock Climb", "Magnet Bomb", "Captivate", "Heal Order", "Ominous Wind", "Telekinesis", "Flame Burst", "Synchronoise", "Chip Away", "Sky Drop", "Bestow", "Heart Stamp", "Steamroller", "Rototiller", "Ion Deluge","Tail Glow", "Heart Swap", "Spotlight", "Psycho Boost","Alakazite + Nasty Plot", "Blastoisinite + Shell Smash", "Kangaskhanite + Seismic Toss", 'Kyurem-Black + Dragon Dance', 'Cinderace + Libero', 'Greninja + Protean', 'Deoxys-Speed + Nasty Plot', 'Power Construct', 'Cinderace + Libero'],
		unbanlist: ['Floette-Eternal'],
	},
	// {
	// 	name: "[Gen 8] (National Dex) WWC Tier",
	// 	mod: 'gen8',
	// 	ruleset: ['Standard NatDex', 'OHKO Clause', 'Evasion Moves Clause', 'Species Clause', 'Dynamax Clause', 'Sleep Clause Mod', 'Z-Move Clause', '+Unreleased'],
	// 	banlist: ["Gengar-Mega", "Kangaskhan-Mega + Seismic Toss", "Mewtwo", "Lugia", "Ho-Oh", "Blazikenite", "Salamence-Mega", "Metagross-Mega", "Kyogre", "Groudon", "Rayquaza", "Deoxys", "Lucario-Mega", "Dialga", "Palkia", "Giratina", "Darkrai", "Shaymin-Sky", "Arceus", "Reshiram", "Zekrom", "Kyurem-White", "Genesect", "Xerneas", "Yveltal", "Power Construct", "Solgaleo", "Lunala", "Pheromosa", "Necrozma-Dusk-Mane", "Necrozma-Dawn-Wings", "Necrozma-Ultra", "Marshadow", "Naganadel", "Blaziken + Speed Boost", "Greninja + Protean", "Blastoise-Mega + Shell Smash", "Kyurem-Black", "Alakazam-Mega + Nasty Plot", "Deoxys-Speed + Nasty Plot"],
	...
	// },
	{
		...
		mod: 'gen8',
		ruleset: ['Obtainable', 'Standard NatDex', '+Unreleased'],
		banlist: [],
		onBegin() {
